...
DeviceAddress Temp1 = { 0x3B, 0xF2, 0x17, 0x19, 0x00, 0x00, 0x00, 0x38}; //Thermocouple 1
DeviceAddress Temp2 = { 0x3B, 0xF3, 0x17, 0x19, 0x00, 0x00, 0x00, 0x0F}; //Thermocouple 2
DeviceAddress Temp3 = { 0x3B, 0xE3, 0x17, 0x19, 0x00, 0x00, 0x00, 0x54}; //Thermocouple 3
DeviceAddress Temp4 = { 0x28, 0xC7, 0x0E, 0x13, 0x07, 0x00, 0x00, 0x6C}; //Ambient Temp
...
void setup() {
  ...
  server.begin();
  Serial.println("DAQ 1 HTTP server started");
...
void handle_root() {
  server.send(200, "text/plain", "All systems go. Read data on DAQ1 from /T1 or /T2 or /T3 or /T4 or /AmbientTemp or /Light or /Humidity");
  delay(10);
}
