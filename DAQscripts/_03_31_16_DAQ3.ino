...
DeviceAddress Temp1 = { 0x3B, 0xED, 0x17, 0x19, 0x00, 0x00, 0x00, 0x47}; //Thermocouple 1
DeviceAddress Temp2 = { 0x3B, 0xE4, 0x17, 0x19, 0x00, 0x00, 0x00, 0xD1}; //Thermocouple 2
DeviceAddress Temp3 = { 0x3B, 0xE9, 0x17, 0x19, 0x00, 0x00, 0x00, 0x9B}; //Thermocouple 3
DeviceAddress Temp4 = { 0x28, 0x57, 0x0F, 0x13, 0x07, 0x00, 0x00, 0x10}; //Ambient Temp
...
//  });
  ...
  server.begin();
  Serial.println("DAQ 3 HTTP server started");
...
void handle_root() {
  server.send(200, "text/plain", "All systems go. Read data on DAQ3 from /T1 or /T2 or /T3 or /T4 or /AmbientTemp or /Light or /Humidity");
}
