	...
	$scope.DAQ1 = function(sensorType, data){
       ...
       console.log ("Ambient Temp (F) selected");
...

        {
            name: 'DAQ2',
            data: [
                [Date.UTC(2015, 12, 7, 1, 35), 29.9],
                [Date.UTC(2015, 12, 8, 1, 45), 71.5],
                [Date.UTC(2015, 12, 11, 4, 13), 106.4],
                [Date.UTC(2015, 12, 12, 5, 11), 129.2],
                [Date.UTC(2015, 12, 13, 6, 12), 144.0],
                [Date.UTC(2015, 12, 14, 6, 52), 176.0]
                ]
        },
        {
            name: 'DAQ3',
